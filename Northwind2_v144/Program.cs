...
using Northwind2_v144.Middlewares;
using Northwind2_v144.Services;
using Northwind2_v144.V2.Services;
using NSwag.AspNetCore;
using Serilog;
using System;
using System.Text.Json.Serialization;

namespace Northwind2_v144
{
    public class Program
	{
		public static void Main(string[] args)
		{
			...
			builder.Services.AddScoped<V1.Services.IServiceClients, V1.Services.ServiceClients>();
